...
//        }
//        MPI_Recv(recvarr, block, MPI_INT, 1, 1, MPI_COMM_WORLD, &status);
//        MPI_Recv(recvarr2, block, MPI_INT, 2, 1, MPI_COMM_WORLD, &status);
//        MPI_Recv(recvarr3, block, MPI_INT, 3, 1, MPI_COMM_WORLD, &status);
